    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            "Septiembre","Octubre","Noviembre","Diciembre");
             ...
             $this->Cell(105,10,'VENTAS AL CREDITO DEL MES '.$mes,0,0,'C');
...
// Page footer
   ...
   $mes = DateTime::createFromFormat('m/Y', $mes)->format('m-Y');
    ...
    $objVenta =  new Venta();
    $listado = $objVenta->Listar_Ventas('MES',$mes,'',2);
...
try {
    ...
    if (is_array($listado) || is_object($listado))
    {
        ...
        $pdf->Text(10,$get_Y + 10,'MONTO TOTAL EN VENTAS AL CREDITO ESTE MES : '.number_format($total, 2, '.', ','));
