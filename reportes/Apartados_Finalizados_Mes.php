...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(105,10,'APARTADOS FINALIZADOS DEL MES '.$mes,0,0,'C');
            // Line break
            $this->Ln(20);
        }
    }
...
// Page footer
   ...
   $mes = DateTime::createFromFormat('m/Y', $mes)->format('m-Y');
    ...
    $listado = $objApartado ->Listar_Apartados('MES',$mes,'',2);
...
try {
    ...
    $pdf->Output('I','Apartados_Finalizados_'.$mes_actual.'_del_'.$ano.'.pdf');
