...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(105,10,'PRODUCTOS APARTADOS FINALIZADOS DEL MES '.$mes,0,0,'C');
            // Line break
            $this->Ln(20);
        }
    }
...
// Page footer
   ...
   $mes = DateTime::createFromFormat('m/Y', $mes)->format('m-Y');
    ...
    $listado = $objApartado->Listar_Apartados_Detalle('MES',$mes,'',2);
    $totales = $objApartado->Listar_Apartados_Totales('MES',$mes,'',2);
