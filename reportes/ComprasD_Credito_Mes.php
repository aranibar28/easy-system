...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->page == 1)
        {
            ...
            $this->Cell(98);
            // Title
            $this->Cell(105,10,'COMPRAS (DETALLADAS) AL CREDITO DEL MES '.$mes,0,0,'C');
            // Line break
            $this->Ln(20);
        }
    }
...
// Page footer
    ...
    $listado = $objCompra->Listar_Compras_Detalle('MES',$mes,'','',2);
    $totales = $objCompra->Listar_Compras_Totales('MES',$mes,'','',2);
