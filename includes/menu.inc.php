					...
					<?php  if($tipo_usuario == '1'){ ?>
						...
						<li>
							...
							<ul>
								...
								<li><a href="./?View=Factura">Emitir Factura</a></li>
								<li><a href="./?View=Boleta">Emitir Boleta</a></li>
