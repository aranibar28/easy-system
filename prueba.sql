...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-10-2021 a las 08:24:48
...
-- Procedimientos
--
CREATE PROCEDURE `sp_abrir_caja` (IN `p_monto_apertura` DECIMAL(8,2))  BEGIN
...
CREATE PROCEDURE `sp_abrir_inventario` ()  BEGIN
...
CREATE PROCEDURE `sp_anular_apartado` (IN `p_idapartado` INT(11))  BEGIN	
...
CREATE PROCEDURE `sp_anular_compra` (IN `p_idcompra` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_anular_venta` (IN `p_idventa` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_cerrar_caja` (IN `p_monto_cierre` DECIMAL(8,2))  BEGIN
...
CREATE PROCEDURE `sp_cerrar_caja_manual` (IN `p_id` INT)  BEGIN
	UPDATE caja SET
    estado = 0 WHERE idcaja = p_id;
END$$

CREATE PROCEDURE `sp_cerrar_inventario` ()  BEGIN
...
CREATE PROCEDURE `sp_cerrar_inventario_manual` ()  BEGIN
...
CREATE PROCEDURE `sp_compras_anual` ()  BEGIN
...
CREATE PROCEDURE `sp_consulta_apartados` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2))  BEGIN
...
CREATE PROCEDURE `sp_consulta_apartados_detalle` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2))  BEGIN
...
CREATE PROCEDURE `sp_consulta_apartados_totales` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2))  BEGIN
...
CREATE PROCEDURE `sp_consulta_compras` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2), IN `p_pago` VARCHAR(2))  BEGIN
...
CREATE PROCEDURE `sp_consulta_compras_detalle` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2), IN `p_pago` VARCHAR(2))  BEGIN
...
CREATE PROCEDURE `sp_consulta_compras_totales` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2), IN `p_pago` VARCHAR(2))  BEGIN
...
CREATE PROCEDURE `sp_consulta_historico_precios` (IN `p_idproducto` INT(11))  BEGIN

		SELECT * FROM view_historico_precios WHERE idproducto = p_idproducto;

	END$$

CREATE PROCEDURE `sp_consulta_precio_mas_bajo` (IN `p_idproducto` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_consulta_ventas` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2))  BEGIN
...
CREATE PROCEDURE `sp_consulta_ventas_detalle` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2))  BEGIN
...
CREATE PROCEDURE `sp_consulta_ventas_totales` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10), IN `p_estado` VARCHAR(2))  BEGIN
...
CREATE PROCEDURE `sp_corte_z_day` (IN `p_day` DATE)  BEGIN
...
CREATE PROCEDURE `sp_corte_z_mes` (IN `p_month` VARCHAR(7))  BEGIN
...
CREATE PROCEDURE `sp_count_apartados` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
...
CREATE PROCEDURE `sp_count_compras` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
...
CREATE PROCEDURE `sp_count_cotizaciones` (IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
...
CREATE PROCEDURE `sp_count_creditos` ()  BEGIN
...
CREATE PROCEDURE `sp_count_creditos_proveedor` ()  BEGIN
...
CREATE PROCEDURE `sp_count_ordenes` (IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
...
CREATE PROCEDURE `sp_count_ventas` (IN `p_criterio` VARCHAR(10), IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
...
CREATE PROCEDURE `sp_delete_abono` (IN `p_idabono` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_delete_abono_proveedor` (IN `p_idabonoproveedor` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_delete_cotizacion` (IN `p_idcotizacion` INT(11))  BEGIN
DELETE FROM `cotizacion`
WHERE `idcotizacion` = p_idcotizacion;
END$$

CREATE PROCEDURE `sp_delete_ordentaller` (IN `p_idorden` INT(11))  BEGIN
	DELETE FROM `ordentaller`
	WHERE `idorden` = p_idorden;
END$$

CREATE PROCEDURE `sp_delete_perecedero` (IN `p_fecha_vencimiento` DATE, IN `p_idproducto` INT(11))  BEGIN
	DELETE FROM `perecedero` WHERE `idproducto` =  p_idproducto
    AND `fecha_vencimiento` = p_fecha_vencimiento;
END$$

CREATE PROCEDURE `sp_descontar_perecedero` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(8,2), IN `p_fecha_vencimiento` DATE)  BEGIN
...
CREATE PROCEDURE `sp_detalle_imprimir_factura_venta` (IN `p_idventa` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_detalle_imprimir_ticket_apartado` (IN `p_idapartado` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_detalle_imprimir_ticket_venta` (IN `p_idventa` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_devolver_productos_apartados` ()  BEGIN
...
CREATE PROCEDURE `sp_fechas_vencimiento` (IN `p_idproducto` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_finalizar_venta` (IN `p_idventa` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_historico_caja` (IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
    IF (p_date = '' AND p_date2 = '') THEN
...
CREATE PROCEDURE `sp_imprimir_ticket` (IN `p_idventa` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_imprimir_ticket_abono` (IN `p_idabono` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_imprimir_ticket_abono_proveedor` (IN `p_idabonoproveedor` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_imprimir_ticket_apartado` (IN `p_idapartado` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_insert_abono` (IN `p_idcredito` INT(11), IN `p_monto_abono` DECIMAL(8,2), IN `p_idusuario` INT(11))  BEGIN
DECLARE p_codigo_credito varchar(175);
DECLARE p_monto_restante DECIMAL(8,2);
...
CREATE PROCEDURE `sp_insert_abono_proveedor` (IN `p_idcreditoproveedor` INT(11), IN `p_monto_abono` DECIMAL(8,2), IN `p_idusuario` INT(11))  BEGIN
DECLARE p_codigo_credito varchar(175);
DECLARE p_monto_restante DECIMAL(8,2);
DECLARE p_resta_montos DECIMAL(8,2);
DECLARE p_monto_abonado DECIMAL(8,2);
...
CREATE PROCEDURE `sp_insert_caja_apartado` (IN `p_monto_movimiento` DECIMAL(8,2))  BEGIN
...
CREATE PROCEDURE `sp_insert_caja_movimiento` (IN `p_tipo_movimiento` TINYINT(1), IN `p_monto_movimiento` DECIMAL(8,2), IN `p_descripcion_movimiento` VARCHAR(80))  BEGIN
    DECLARE p_idcaja int(11);
    DECLARE p_tipo_comprobante tinyint(1);
    DECLARE p_numero_comprobante int(11);
...
CREATE PROCEDURE `sp_insert_caja_venta` (IN `p_monto_movimiento` DECIMAL(8,2))  BEGIN
...
CREATE PROCEDURE `sp_insert_categoria` (IN `p_nombre_categoria` VARCHAR(120))  BEGIN
...
CREATE PROCEDURE `sp_insert_cliente` (IN `p_nombre_cliente` VARCHAR(150), IN `p_numero_nit` VARCHAR(70), IN `p_numero_nrc` VARCHAR(45), IN `p_direccion_cliente` VARCHAR(100), IN `p_numero_telefono` VARCHAR(70), IN `p_email` VARCHAR(80), IN `p_giro` VARCHAR(80), IN `p_limite_credito` DECIMAL(8,2))  BEGIN
...
CREATE PROCEDURE `sp_insert_comprobante` (IN `p_nombre_comprobante` VARCHAR(75))  BEGIN
...
CREATE PROCEDURE `sp_insert_credito_compra` (IN `p_monto_credito` DECIMAL(8,2), IN `p_idproveedor` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_insert_credito_venta` (IN `p_monto_credito` DECIMAL(8,2), IN `p_idcliente` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_insert_currency` (IN `p_CurrencyISO` VARCHAR(3), IN `p_Language` VARCHAR(3), IN `p_CurrencyName` VARCHAR(35), IN `p_Money` VARCHAR(30), IN `p_Symbol` VARCHAR(3))  BEGIN
...
CREATE PROCEDURE `sp_insert_detalleapartado` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(8,2), IN `p_precio_unitario` DECIMAL(8,2), IN `p_exento` DECIMAL(8,2), IN `p_descuento` DECIMAL(8,2), IN `p_fecha_vence` DATE, IN `p_importe` DECIMAL(8,2))  BEGIN
...
CREATE PROCEDURE `sp_insert_detallecompra` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(8,2), IN `p_precio_unitario` DECIMAL(8,2), IN `p_exento` DECIMAL(8,2), IN `p_fecha_vencimiento` DATE, IN `p_importe` DECIMAL(8,2))  BEGIN
...
CREATE PROCEDURE `sp_insert_detallecotizacion` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(8,2), IN `p_disponible` TINYINT(1), IN `p_precio_unitario` DECIMAL(8,2), IN `p_exento` DECIMAL(8,2), IN `p_descuento` DECIMAL(8,2), IN `p_importe` DECIMAL(8,2))  BEGIN
...
CREATE PROCEDURE `sp_insert_detalleventa` (IN `p_idproducto` INT(11), IN `p_cantidad` DECIMAL(8,2), IN `p_precio_unitario` DECIMAL(8,2), IN `p_exento` DECIMAL(8,2), IN `p_descuento` DECIMAL(8,2), IN `p_fecha_vence` DATE, IN `p_importe` DECIMAL(8,2))  BEGIN
...
CREATE PROCEDURE `sp_insert_diagnostico` (IN `p_idorden` INT(11), IN `p_diagnostico` VARCHAR(200), IN `p_estado_aparato` VARCHAR(200), IN `p_repuestos` DECIMAL(8,2), IN `p_mano_obra` DECIMAL(8,2), IN `p_fecha_alta` DATETIME, IN `p_fecha_retiro` DATETIME, IN `p_ubicacion` VARCHAR(150), IN `p_parcial_pagar` DECIMAL(8,2))  BEGIN
	UPDATE `ordentaller`
...
CREATE PROCEDURE `sp_insert_empleado` (IN `p_nombre_empleado` VARCHAR(90), IN `p_apellido_empleado` VARCHAR(90), IN `p_telefono_empleado` VARCHAR(70), IN `p_email_empleado` VARCHAR(80))  BEGIN
...
CREATE PROCEDURE `sp_insert_entrada` (IN `p_descripcion_entrada` VARCHAR(150), IN `p_cantidad_entrada` DECIMAL(8,2), IN `p_idproducto` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_insert_marca` (IN `p_nombre_marca` VARCHAR(120))  BEGIN
...
CREATE PROCEDURE `sp_insert_ordentaller` (IN `p_idcliente` INT(11), IN `p_aparato` VARCHAR(125), IN `p_modelo` VARCHAR(125), IN `p_idmarca` INT(11), IN `p_serie` VARCHAR(125), IN `p_idtecnico` INT(11), IN `p_averia` VARCHAR(200), IN `p_observaciones` VARCHAR(200), IN `p_deposito_revision` DECIMAL(8,2), IN `p_deposito_reparacion` DECIMAL(8,2), IN `p_parcial_pagar` DECIMAL(8,2))  BEGIN
...
CREATE PROCEDURE `sp_insert_parametro` (IN `p_nombre_empresa` VARCHAR(150), IN `p_propietario` VARCHAR(150), IN `p_numero_nit` VARCHAR(70), IN `p_numero_nrc` VARCHAR(70), IN `p_porcentaje_iva` DECIMAL(8,2), IN `p_porcentaje_retencion` DECIMAL(8,2), IN `p_monto_retencion` DECIMAL(8,2), IN `p_direccion_empresa` VARCHAR(200), IN `p_idcurrency` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_insert_perecedero` (IN `p_fecha_vencimiento` DATE, IN `p_cantidad_perecedero` DECIMAL(8,2), IN `p_idproducto` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_insert_presentacion` (IN `p_nombre_presentacion` VARCHAR(120), IN `p_siglas` VARCHAR(45))  BEGIN
...
CREATE PROCEDURE `sp_insert_producto` (IN `p_codigo_barra` VARCHAR(200), IN `p_nombre_producto` VARCHAR(175), IN `p_precio_compra` DECIMAL(8,2), IN `p_precio_venta` DECIMAL(8,2), IN `p_precio_venta_mayoreo` DECIMAL(8,2), IN `p_precio_venta_3` DECIMAL(8,2), IN `p_stock` DECIMAL(8,2), IN `p_stock_min` DECIMAL(8,2), IN `p_idcategoria` INT(11), IN `p_idmarca` INT(11), IN `p_idpresentacion` INT(11), IN `p_exento` TINYINT(1), IN `p_inventariable` TINYINT(1), IN `p_perecedero` TINYINT(1))  BEGIN
	...
	IF (p_inventariable = 1) THEN
     ...
     ELSE
		...
		IF NOT EXISTS (SELECT * FROM `producto` WHERE `nombre_producto` = p_nombre_producto) 
...
CREATE PROCEDURE `sp_insert_proveedor` (IN `p_nombre_proveedor` VARCHAR(175), IN `p_numero_telefono` VARCHAR(70), IN `p_numero_nit` VARCHAR(70), IN `p_numero_nrc` VARCHAR(70), IN `p_nombre_contacto` VARCHAR(150), IN `p_telefono_contacto` VARCHAR(150))  BEGIN
...
CREATE PROCEDURE `sp_insert_salida` (IN `p_descripcion_salida` VARCHAR(150), IN `p_cantidad_salida` DECIMAL(8,2), IN `p_idproducto` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_insert_subcategoria` (IN `p_idcategoria` INT, IN `p_desubcategorias` VARCHAR(450))  BEGIN
  IF NOT EXISTS (SELECT * FROM `desubcategorias` WHERE `desubcategorias` = p_desubcategorias) THEN
		INSERT INTO `desubcategorias`(`idcategoria`,`desubcategorias`)
		VALUES (p_idcategoria,p_desubcategorias);
    END IF;
END$$

CREATE PROCEDURE `sp_insert_tecnico` (IN `p_tecnico` VARCHAR(150), IN `p_telefono` VARCHAR(70))  BEGIN
...
CREATE PROCEDURE `sp_insert_tiraje_comprobante` (IN `p_fecha_resolucion` DATETIME, IN `p_numero_resolucion` VARCHAR(100), IN `p_serie` VARCHAR(175), IN `p_desde` INT(11), IN `p_hasta` INT(11), IN `p_disponibles` INT(11), IN `p_idcomprobante` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_insert_usuario` (IN `p_usuario` VARCHAR(70), IN `p_contrasena` VARCHAR(12), IN `p_tipo_usuario` TINYINT(1), IN `p_idempleado` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_kardex_inventario` (IN `p_mes` VARCHAR(7))  BEGIN
...
CREATE PROCEDURE `sp_login_usuario` (IN `p_usuario` VARCHAR(70), IN `p_contrasena` VARCHAR(12))  BEGIN
...
CREATE PROCEDURE `sp_panel_dashboard` ()  BEGIN
...
CREATE PROCEDURE `sp_print_barcode_producto` (IN `p_id` INT)  BEGIN
SELECT codigo_barra,codigo_interno,nombre_producto FROM producto WHERE idproducto = p_id;
END$$

CREATE PROCEDURE `sp_sacar_vencidos` ()  BEGIN
...
CREATE PROCEDURE `sp_search_producto` (IN `p_search` VARCHAR(175))  BEGIN
...
CREATE PROCEDURE `sp_search_producto_apartado` (IN `p_search` VARCHAR(175))  BEGIN
...
CREATE PROCEDURE `sp_search_producto_cotizacion` (IN `p_search` VARCHAR(175))  BEGIN
SELECT idproducto,codigo_interno,codigo_barra,nombre_producto,siglas,nombre_marca,
...
CREATE PROCEDURE `sp_search_producto_venta` (IN `p_search` VARCHAR(175))  BEGIN
SELECT * FROM view_productos_venta WHERE codigo_barra LIKE CONCAT('%',p_search,'%')
OR nombre_producto LIKE CONCAT('%',p_search,'%') OR codigo_interno LIKE CONCAT('%',p_search,'%')
ORDER BY idproducto DESC;
END$$

CREATE PROCEDURE `sp_update_abono` (IN `p_idabono` INT(11), IN `p_fecha_abono` DATETIME, IN `p_monto_abono` DECIMAL(8,2))  BEGIN
UPDATE `abono`
SET  `fecha_abono` = p_fecha_abono, `monto_abono` = p_monto_abono
WHERE `idabono` = p_idabono;
END$$

CREATE PROCEDURE `sp_update_abono_proveedor` (IN `p_idabonoproveedor` INT(11), IN `p_fecha_abono` DATETIME, IN `p_monto_abono` DECIMAL(8,2))  BEGIN
UPDATE `abonoproveedor`
SET  `fecha_abono` = p_fecha_abono, `monto_abono` = p_monto_abono
WHERE `idabonoproveedor` = p_idabonoproveedor;
END$$

CREATE PROCEDURE `sp_update_categoria` (IN `p_idcategoria` INT(11), IN `p_nombre_categoria` VARCHAR(120), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `categoria`
SET `nombre_categoria` = p_nombre_categoria, `estado` = p_estado
WHERE `idcategoria` = p_idcategoria;
END$$

CREATE PROCEDURE `sp_update_cliente` (IN `p_idcliente` INT(11), IN `p_nombre_cliente` VARCHAR(150), IN `p_numero_nit` VARCHAR(70), IN `p_numero_nrc` VARCHAR(45), IN `p_direccion_cliente` VARCHAR(100), IN `p_numero_telefono` VARCHAR(70), IN `p_email` VARCHAR(80), IN `p_giro` VARCHAR(80), IN `p_limite_credito` DECIMAL(8,2), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `cliente`
...
CREATE PROCEDURE `sp_update_comprobante` (IN `p_idcomprobante` INT(11), IN `p_nombre_comprobante` VARCHAR(75), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `comprobante`
SET `nombre_comprobante` = p_nombre_comprobante, `estado` = p_estado
WHERE `idcomprobante` = p_idcomprobante;
END$$

CREATE PROCEDURE `sp_update_credito` (IN `p_idcredito` INT(11), IN `p_nombre_credito` VARCHAR(120), IN `p_fecha_credito` DATETIME, IN `p_monto_credito` DECIMAL(8,2), IN `p_monto_abonado` DECIMAL(8,2), IN `p_monto_restante` DECIMAL(8,2), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `credito`
...
CREATE PROCEDURE `sp_update_credito_proveedor` (IN `p_idcreditoproveedor` INT(11), IN `p_nombre_credito` VARCHAR(120), IN `p_fecha_credito` DATETIME, IN `p_monto_credito` DECIMAL(8,2), IN `p_monto_abonado` DECIMAL(8,2), IN `p_monto_restante` DECIMAL(8,2), IN `p_estado` TINYINT(1))  BEGIN
...
CREATE PROCEDURE `sp_update_currency` (IN `p_idcurrency` INT(11), IN `p_CurrencyISO` VARCHAR(3), IN `p_Language` VARCHAR(3), IN `p_CurrencyName` VARCHAR(35), IN `p_Money` VARCHAR(30), IN `p_Symbol` VARCHAR(3))  BEGIN
UPDATE `currency` 
...
CREATE PROCEDURE `sp_update_empleado` (IN `p_idempleado` INT(11), IN `p_nombre_empleado` VARCHAR(90), IN `p_apellido_empleado` VARCHAR(90), IN `p_telefono_empleado` VARCHAR(70), IN `p_email_empleado` VARCHAR(80), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `empleado`
...
CREATE PROCEDURE `sp_update_marca` (IN `p_idmarca` INT(11), IN `p_nombre_marca` VARCHAR(120), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `marca`
SET `nombre_marca` = p_nombre_marca, `estado` = p_estado
WHERE `idmarca` = p_idmarca;
END$$

CREATE PROCEDURE `sp_update_monto_inicial` (IN `p_monto_apertura` DECIMAL(8,2))  BEGIN
...
CREATE PROCEDURE `sp_update_parametro` (IN `p_idparametro` INT(11), IN `p_nombre_empresa` VARCHAR(150), IN `p_propietario` VARCHAR(150), IN `p_numero_nit` VARCHAR(70), IN `p_numero_nrc` VARCHAR(70), IN `p_porcentaje_iva` DECIMAL(8,2), IN `p_porcentaje_retencion` DECIMAL(8,2), IN `p_monto_retencion` DECIMAL(8,2), IN `p_direccion_empresa` VARCHAR(200), IN `p_idcurrency` INT(11))  BEGIN
UPDATE `parametro`
...
CREATE PROCEDURE `sp_update_perecedero` (IN `p_fecha_vencimiento` DATE, IN `p_cantidad_perecedero` DECIMAL(8,2), IN `p_idproducto` INT(11))  BEGIN
  UPDATE `perecedero` SET
  `cantidad_perecedero` = p_cantidad_perecedero
   WHERE `idproducto` =  p_idproducto AND `fecha_vencimiento` = p_fecha_vencimiento;
END$$

CREATE PROCEDURE `sp_update_presentacion` (IN `p_idpresentacion` INT(11), IN `p_nombre_presentacion` VARCHAR(120), IN `p_siglas` VARCHAR(45), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `presentacion`
...
CREATE PROCEDURE `sp_update_producto` (IN `p_idproducto` INT(11), IN `p_codigo_barra` VARCHAR(200), IN `p_nombre_producto` VARCHAR(175), IN `p_precio_compra` DECIMAL(8,2), IN `p_precio_venta` DECIMAL(8,2), IN `p_precio_venta_mayoreo` DECIMAL(8,2), IN `p_precio_venta_3` DECIMAL(8,2), IN `p_stock_min` DECIMAL(8,2), IN `p_idcategoria` INT(11), IN `p_idmarca` INT(11), IN `p_idpresentacion` INT(11), IN `p_estado` TINYINT(1), IN `p_exento` TINYINT(1), IN `p_inventariable` TINYINT(1), IN `p_perecedero` TINYINT(1))  BEGIN
  IF (p_inventariable = 0) THEN
		UPDATE `producto`
		SET `codigo_barra` = p_codigo_barra, `nombre_producto` = p_nombre_producto, 

`precio_compra` = p_precio_compra,
		`precio_venta` = p_precio_venta, `precio_venta_mayoreo` = 

p_precio_venta_mayoreo,`precio_venta_3` = p_precio_venta_3,`stock_min` = 0, `stock` = 0,
		`idcategoria` = p_idcategoria, `idmarca` = p_idmarca, `idpresentacion` = 

p_idpresentacion, `estado` = p_estado,
...
p_precio_venta_mayoreo,`precio_venta_3` = p_precio_venta_3,`stock_min` = p_stock_min,
		`idcategoria` = p_idcategoria, `idmarca` = p_idmarca, `idpresentacion` = 
...
CREATE PROCEDURE `sp_update_proveedor` (IN `p_idproveedor` INT(11), IN `p_nombre_proveedor` VARCHAR(175), IN `p_numero_telefono` VARCHAR(70), IN `p_numero_nit` VARCHAR(70), IN `p_numero_nrc` VARCHAR(70), IN `p_nombre_contacto` VARCHAR(150), IN `p_telefono_contacto` VARCHAR(150), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `proveedor`
...
CREATE PROCEDURE `sp_update_subcategoria` (IN `p_codisubcategoria` INT(11), IN `p_idcategoria` INT(11), IN `p_desubcategorias` VARCHAR(450), IN `p_estado` TINYINT(1))  BEGIN
UPDATE `desubcategorias`
SET `idcategoria` = p_idcategoria, `desubcategorias` = p_desubcategorias, `estado` = p_estado
WHERE `codisubcategoria` = p_codisubcategoria;
END$$

CREATE PROCEDURE `sp_update_tecnico` (IN `p_idtecnico` INT(11), IN `p_tecnico` VARCHAR(150), IN `p_telefono` VARCHAR(70), IN `p_estado` TINYINT(1))  BEGIN
	UPDATE `tecnico`
	SET `tecnico` = p_tecnico, `telefono` = p_telefono, `estado` = p_estado
	WHERE `idtecnico` = p_idtecnico;
END$$

CREATE PROCEDURE `sp_update_tiraje_comprobante` (IN `p_idtiraje` INT(11), IN `p_fecha_resolucion` DATETIME, IN `p_numero_resolucion` VARCHAR(100), IN `p_serie` VARCHAR(175), IN `p_desde` INT(11), IN `p_hasta` INT(11), IN `p_disponibles` INT(11), IN `p_idcomprobante` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_update_usuario` (IN `p_idusuario` INT(11), IN `p_usuario` VARCHAR(70), IN `p_contrasena` VARCHAR(12), IN `p_tipo_usuario` TINYINT(1), IN `p_estado` TINYINT(1), IN `p_idempleado` INT(11))  BEGIN
UPDATE `usuario`
...
CREATE PROCEDURE `sp_validar_caja` ()  BEGIN
		SELECT * FROM caja WHERE DATE(fecha_apertura) = CURDATE()
        AND estado = 1;
	END$$

CREATE PROCEDURE `sp_validar_inventario` ()  BEGIN
...
CREATE PROCEDURE `sp_ventas_anual` ()  BEGIN
...
CREATE PROCEDURE `sp_view_abonos` (IN `p_idcredito` INT(11))  BEGIN
	SELECT * FROM view_abonos WHERE idcredito = p_idcredito;
END$$

CREATE PROCEDURE `sp_view_abonos_proveedor` (IN `p_idcreditoproveedor` INT(11))  BEGIN
	SELECT * FROM view_abonos_proveedor WHERE idcreditoproveedor = p_idcreditoproveedor;
END$$

CREATE PROCEDURE `sp_view_all_abonos` ()  BEGIN
	SELECT * FROM view_abonos;
END$$

CREATE PROCEDURE `sp_view_all_abonos_proveedor` ()  BEGIN
	SELECT * FROM view_abonos_proveedor;
END$$

CREATE PROCEDURE `sp_view_apartado` (IN `p_idapartado` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_view_categoria` ()  BEGIN
SELECT `idcategoria`, `nombre_categoria`, `estado`
FROM `categoria`;
END$$

CREATE PROCEDURE `sp_view_categoria_activa` ()  BEGIN
SELECT `idcategoria`, `nombre_categoria`, `estado`
FROM `categoria` WHERE `estado` = 1;
END$$

CREATE PROCEDURE `sp_view_cliente` ()  BEGIN
...
CREATE PROCEDURE `sp_view_cliente_activo` ()  BEGIN
SELECT `idcliente`, `codigo_cliente`, `nombre_cliente`, `numero_nit`,
`numero_nrc`, `direccion_cliente`, `numero_telefono`, `email`,
`giro`, `limite_credito`, `estado`
...
CREATE PROCEDURE `sp_view_cliente_inactivo` ()  BEGIN
SELECT `idcliente`, `codigo_cliente`, `nombre_cliente`, `numero_nit`,
`numero_nrc`, `direccion_cliente`, `numero_telefono`, `email`,
`giro`, `limite_credito`, `estado`
...
CREATE PROCEDURE `sp_view_compra` (IN `p_idcompra` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_view_comprobante` ()  BEGIN
SELECT `idcomprobante`, `nombre_comprobante`, `estado`
FROM `comprobante`;
END$$

CREATE PROCEDURE `sp_view_comprobante_activo` ()  BEGIN
SELECT `idcomprobante`, `nombre_comprobante` FROM `comprobante` WHERE `estado` = 1;
END$$

CREATE PROCEDURE `sp_view_cotizacion` (IN `p_fecha` VARCHAR(32), IN `p_fecha2` VARCHAR(32))  BEGIN
...
CREATE PROCEDURE `sp_view_cotizacion_detalle` (`p_idcotizacion` INT)  BEGIN
...
CREATE PROCEDURE `sp_view_creditos` (IN `p_criterio` TINYINT(1))  BEGIN
	SELECT * FROM view_creditos_venta WHERE estado_credito = p_criterio;
END$$

CREATE PROCEDURE `sp_view_creditos_espc` (IN `p_idcredito` INT)  BEGIN
	SELECT * FROM view_creditos_venta WHERE idcredito = p_idcredito;
END$$

CREATE PROCEDURE `sp_view_creditos_espc_proveedor` (IN `p_idcreditoproveedor` INT)  BEGIN
	SELECT * FROM view_creditos_compra WHERE idcreditoproveedor = p_idcreditoproveedor;
END$$

CREATE PROCEDURE `sp_view_creditos_proveedor` (IN `p_criterio` TINYINT(1))  BEGIN
	SELECT * FROM view_creditos_compra WHERE estado_credito = p_criterio;
END$$

CREATE PROCEDURE `sp_view_currency` ()  BEGIN
SELECT `idcurrency`, `CurrencyISO`, `Language`, `CurrencyName`, 
`Money`, `Symbol`
FROM `currency`;
END$$

CREATE PROCEDURE `sp_view_datos_caja` ()  BEGIN
...
CREATE PROCEDURE `sp_view_datos_caja_fecha` (IN `p_fecha` VARCHAR(32))  BEGIN
   SELECT COUNT(*) as veces_abierta, fecha_apertura, fecha_cierre , estado, monto_apertura
   FROM caja WHERE DATE(fecha_apertura) = p_fecha;
END$$

CREATE PROCEDURE `sp_view_detalleapartado` (IN `p_idapartado` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_view_detallecompra` (IN `p_idcompra` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_view_detalleventa` (IN `p_idventa` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_view_gastos_caja` ()  BEGIN
   SELECT * FROM view_caja WHERE tipo_movimiento = 4 AND DATE(fecha_apertura) = CURDATE();
END$$

CREATE PROCEDURE `sp_view_impuesto` ()  BEGIN
SELECT `porcentaje_iva`,`porcentaje_retencion`,`monto_retencion`  FROM `parametro`;
END$$

CREATE PROCEDURE `sp_view_info_cotizacion` (IN `p_idcotizacion` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_view_ingresos_caja` ()  BEGIN
   SELECT * FROM view_caja WHERE tipo_movimiento = 1 AND DATE(fecha_apertura) = CURDATE();
END$$

CREATE PROCEDURE `sp_view_limite_credito` (IN `p_idcliente` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_view_marca` ()  BEGIN
SELECT `idmarca`, `nombre_marca`, `estado`
FROM `marca`;
END$$

CREATE PROCEDURE `sp_view_marca_activa` ()  BEGIN
SELECT `idmarca`, `nombre_marca`, `estado`
FROM `marca` WHERE `estado` = 1;
END$$

CREATE PROCEDURE `sp_view_money` ()  BEGIN
DECLARE p_idcurrency INT;
...
CREATE PROCEDURE `sp_view_monto_credito` (IN `p_idcredito` INT(11))  BEGIN
	SELECT monto_restante FROM credito WHERE idcredito = p_idcredito;
END$$

CREATE PROCEDURE `sp_view_monto_credito_proveedor` (IN `p_idcreditoproveedor` INT(11))  BEGIN
	SELECT monto_restante FROM creditoproveedor WHERE idcreditoproveedor = p_idcreditoproveedor;
END$$

CREATE PROCEDURE `sp_view_movimientos_caja` ()  BEGIN
...
CREATE PROCEDURE `sp_view_movimientos_caja_fecha` (IN `p_fecha` VARCHAR(32))  BEGIN
...
CREATE PROCEDURE `sp_view_movimientos_detalle_fecha` (IN `p_fecha` VARCHAR(32))  BEGIN
...
CREATE PROCEDURE `sp_view_ordentaller` (IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
...
CREATE PROCEDURE `sp_view_parametro` ()  BEGIN
...
CREATE PROCEDURE `sp_view_perecedero` (IN `p_desde` DATE, IN `p_hasta` DATE)  BEGIN
...
CREATE PROCEDURE `sp_view_proveedor_activo` ()  BEGIN
SELECT `idproveedor`, `codigo_proveedor`, `nombre_proveedor`, `numero_telefono`,
`numero_nit`, `numero_nrc`, `nombre_contacto`, `telefono_contacto`,
`estado`
...
CREATE PROCEDURE `sp_view_report_ordentaller` (IN `p_id` INT)  BEGIN
	DECLARE p_idmax int;
	 IF (p_id  = '0') THEN
...
CREATE PROCEDURE `sp_view_salidas` (IN `p_mes` VARCHAR(7))  BEGIN
    IF (p_mes!='') THEN
...
CREATE PROCEDURE `sp_view_stock_producto_perecedero` (IN `p_idproducto` INT(11))  BEGIN
...
CREATE PROCEDURE `sp_view_subcategoria` ()  BEGIN
SELECT `codisubcategoria`, `idcategoria`, `desubcategorias`, `estado`
FROM `subcategorias`;
END$$

CREATE PROCEDURE `sp_view_tecnico` ()  BEGIN
	SELECT `idtecnico`, `tecnico`, `telefono`, `estado`
	FROM `tecnico`;
END$$

CREATE PROCEDURE `sp_view_tecnico_activo` ()  BEGIN
	SELECT `idtecnico`, `tecnico`, `telefono`, `estado`
	FROM `tecnico` WHERE `estado` = 1;
END$$

CREATE PROCEDURE `sp_view_tiraje` ()  BEGIN
SELECT * FROM view_comprobantes;
END$$

CREATE PROCEDURE `sp_view_tiraje_activo` ()  BEGIN
SELECT idcomprobante, nombre_comprobante FROM view_comprobantes WHERE estado = 1 AND
disponibles > 0;
END$$

CREATE PROCEDURE `sp_view_total_abonos_fechas` (IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
...
CREATE PROCEDURE `sp_view_total_abonos_proveedor_fechas` (IN `p_date` VARCHAR(10), IN `p_date2` VARCHAR(10))  BEGIN
		 SELECT codigo_credito, nombre_credito, monto_abono, DATE_FORMAT(fecha_abono,'%d/%m/%Y') as fecha_abono
         FROM view_abonos_proveedor WHERE DATE_FORMAT(fecha_abono,'%Y-%m-%d') BETWEEN p_date AND p_date2
		 ORDER BY monto_abono, DATE_FORMAT(fecha_abono,'%d/%m/%Y')  DESC;
	END$$

CREATE PROCEDURE `sp_view_usuario` ()  BEGIN
SELECT * FROM view_usuarios;
END$$

CREATE PROCEDURE `sp_view_venta` (IN `p_idventa` INT(11))  BEGIN
...
(1, '2020-10-30 17:37:12', '12.00', '0.00', NULL, 1),
(2, '2020-11-26 18:09:34', '100.00', '0.00', NULL, 1),
(3, '2021-10-03 19:24:44', '100.00', '0.00', NULL, 1),
(4, '2021-10-04 02:19:34', '350.00', '0.00', NULL, 1),
(5, '2021-10-17 18:17:41', '200.00', '0.00', NULL, 1),
(6, '2021-10-18 02:21:07', '400.00', '0.00', NULL, 1);
...
(5, 1, '120.00', 'POR VENTA BOLETA # 1', '2021-10-17'),
(6, 1, '60.00', 'POR VENTA BOLETA # 2', '2021-10-18'),
(6, 1, '20.00', 'POR VENTA BOLETA # 3', '2021-10-18');
...
(1, 'SISTEMA ELECTRICO', 1),
(2, 'PROTECCION', 1),
(3, 'EQUIPAMIENTO', 1),
(4, 'UTILES DE OFICINA', 1),
(5, 'SUMINISTROS', 1),
(6, 'INFANTIL', 1),
(7, 'COMESTIBLE', 1),
(8, 'FITNESS', 1),
...
(1, 'CL00000001', 'JUAN CARLOS', '56556637', '13567876763', 'JR CIRO ALEGRIA 607', '955020349', 'ejemplo@gmail.com', 'VENTA', '100000.00', 1);
...
(1, '2021-10-03 18:36:59', 5, '1', '04508', '1', '2021-10-03', '2475.00', '445.50', '0.00', '0.00', '2920.50', 'DOS MIL NOVECIENTOS VEINTE 50/100', 1),
(2, '2021-10-03 18:38:53', 5, '1', '04509', '1', '2021-10-03', '250.00', '45.00', '0.00', '0.00', '295.00', 'DOSCIENTOS NOVENTA Y CINCO 00/100', 1),
(3, '2021-10-17 18:19:05', 6, '1', '04508', '1', '2021-10-17', '450.00', '81.00', '0.00', '0.00', '531.00', 'QUINIENTOS TREINTA Y UNO 00/100', 1),
(4, '2021-10-18 23:13:25', 5, '1', '04508', '2', '2021-10-18', '9.00', '1.62', '0.00', '0.00', '10.62', 'DIEZ 62/100', 1);
...
(1, 'COTI00000001', '2021-10-04 02:14:56', 'JUAN CARLOS', 'AL CONTADO', 'INMEDIATA', '318.64', '0.00', '0.00', '0.00', '0.00', '376.00', 'Trescientos setenta y seis 00/100', 1, 1),
(2, 'COTI00000002', '2021-10-17 23:49:26', 'JUAN CARLOS', 'AL CONTADO', 'INMEDIATA', '25.42', '0.00', '0.00', '0.00', '0.00', '30.00', 'Treinta 00/100', 1, 1);
...
CREATE TABLE `creditoproveedor` (
  `idcreditoproveedor` int(11) NOT NULL,
  `idcompra` int(11) NOT NULL,
  `codigo_credito` varchar(175) COLLATE utf8_unicode_ci DEFAULT NULL,
  `nombre_credito` varchar(120) COLLATE utf8_unicode_ci NOT NULL,
  `fecha_credito` datetime NOT NULL,
...
(1, 'MXN', 'ES', 'PESOS', 'PESOS', '$'),
(2, 'PEN', 'ES', 'Nuevo sol', '#', 'S/.'),
(3, 'GS', 'EN', 'Guarani', 'GUARANIES PARAGUAYO', 'G'),
(4, 'PYG', 'ES', 'Guaranies', 'uaranÃ­ paraguayo', 'â‚²'),
(5, 'QTG', 'ES', 'Quetzal Guatemala', 'QTG', 'Q.'),
(6, 'USD', 'EN', 'DOLAR ESTADOUNIDENSE', 'US DOLAR', '$'),
(7, 'NIO', 'ES', 'Cordoba oro', 'CORDOBA', 'C$'),
(8, 'BOB', 'ES', 'Peso Boliviano', 'BOLIVIANO', 'BOB'),
(9, 'RAL', 'ES', 'REAL', 'REAL', '$'),
(10, 'USD', 'EN', 'Dolar Estado', 'DOLAR', '$'),
(11, 'ARS', 'ES', 'Peso Argentino', 'PESO ARGENTINO', '$'),
(12, 'COP', 'ES', 'Peso Colombiano', 'COP PESO', '$'),
(13, 'DOP', 'ES', 'Peso Dominicano', 'PESO DOMINICANO', 'DOP'),
(14, 'HNL', 'ES', 'Lempira HondureÃ±o', 'HN LEMPIRA', 'L.'),
(15, 'COP', 'ES', 'PESO', 'PESO COLOMBIANO', '$'),
(16, 'NIO', 'ES', 'CÃ³rdoba Nicaraguense', 'CORDOBA', 'Â©');
...
(1, 4, NULL, '50.00', '4.50', '0.00', '225.00'),
(1, 1, NULL, '50.00', '45.00', '0.00', '2250.00'),
(2, 3, NULL, '100.00', '2.50', '0.00', '250.00'),
(3, 4, NULL, '100.00', '4.50', '0.00', '450.00'),
(4, 4, NULL, '2.00', '4.50', '0.00', '9.00');
...
(1, 4, '2.00', 1, '10.00', '0.00', '0.00', '20.00'),
(1, 1, '4.00', 1, '89.00', '0.00', '0.00', '356.00'),
(2, 4, '3.00', 1, '10.00', '0.00', '0.00', '30.00');
...
(1, 4, '12.00', '10.00', NULL, '0.00', '0.00', '120.00'),
(2, 4, '6.00', '10.00', NULL, '0.00', '0.00', '60.00'),
(3, 4, '2.00', '10.00', NULL, '0.00', '0.00', '20.00');
...
CREATE TABLE `emisor` (
  ...
  `usuario_secundario` varchar(20) DEFAULT NULL,
  `clave_usuario_secundario` varchar(20) DEFAULT NULL
...
INSERT INTO `emisor` (`id`, `tipodoc`, `ruc`, `razon_social`, `nombre_comercial`, `direccion`, `pais`, `departamento`, `provincia`, `distrito`, `ubigeo`, `usuario_secundario`, `clave_usuario_secundario`) VALUES
(1, '6', '20123456789', 'EMPRESA EMISORA', 'EMPRESA EMISORA', 'DIRECCION NRO 123 - CHICLAYO - CHICLAYO - LAMBAYEQUE', 'PE', 'LAMBAYEQUE', 'CHICLAYO', 'CHICLAYO', '140101', 'MODDATOS', 'MODDATOS');
...
(1, 'EM00000001', 'PEDRO PABLO', 'BLAS DELGADO', '992446125', 'sistemas@gmail.com', 1),
(2, 'EM00000002', 'JUAN', 'PEREZ', '4565465464', 'jkdkdsjfh@gmail.com', 0),
(3, 'EM00000003', 'VICTOR', 'SANDOVAL', '924115522', '', 0),
(4, 'EM00000004', 'DELMAR', 'QUIJADA', '8090000000', 'dquijada@mail.com', 1),
(5, 'EM00000005', 'WILSON', 'FERNANDEZ', '9587485', 'wilsonj@sistemas.pe', 1),
(6, 'EM00000006', 'PEPE', 'PEPE', '52533644522', 'pepe@pepe.com', 1),
(7, 'EM00000007', 'ROY CARLOS', 'HUAYRE', '92978999', '', 1),
(8, 'EM00000008', 'ALBERTO', 'LOPEZ', '5050\'505\'', 'hendrix.fuentes@tex.com', 1),
(9, 'EM00000009', 'WILMAN', 'AGUILAR', '3005740848', 'wilmanaguilar2012@gmail.com', 1),
(10, 'EM00000010', 'DIEGO ARMANDO', 'CARRENO', '3234342312', 'ingdacs192@gmail.com', 1),
(11, 'EM00000011', 'JOSE', 'HUARCAYA', '986737462', 'jo_lu51@hotmail.com', 1);
...
(1, '2020-10', '2020-10-30', 'INVENTARIO INICIAL', '12.00', '45.00', '540.00', 1, NULL, NULL),
(2, '2021-06', '2021-06-16', 'INVENTARIO INICIAL', '16.00', '3.80', '60.80', 2, NULL, NULL),
(3, '2021-06', '2021-06-16', 'INVENTARIO INICIAL', '0.00', '2.50', '0.00', 3, NULL, NULL),
(4, '2021-06', '2021-06-16', 'INVENTARIO INICIAL', '6.00', '4.50', '27.00', 4, NULL, NULL),
(5, '2021-10', '2021-10-03', 'POR COMPRA TICKET # 04508', '50.00', '4.50', '225.00', 4, 1, NULL),
(6, '2021-10', '2021-10-03', 'POR COMPRA TICKET # 04508', '50.00', '45.00', '2250.00', 1, 1, NULL),
(7, '2021-10', '2021-10-03', 'POR COMPRA TICKET # 04509', '100.00', '2.50', '250.00', 3, 2, NULL),
(8, '2021-10', '2021-10-17', 'POR COMPRA TICKET # 04508', '100.00', '4.50', '450.00', 4, 3, NULL),
(9, '2021-10', '2021-10-18', 'POR COMPRA FACTURA # 04508', '2.00', '4.50', '9.00', 4, 4, NULL);
...
('2020-10', '2020-10-01', '2020-10-31', '12.00', '12.00', '0.00', '12.00', 0, 1),
('2020-11', '2020-11-01', '2020-11-30', '12.00', '0.00', '0.00', '12.00', 0, 1),
('2021-06', '2021-06-01', '2021-06-30', '12.00', '0.00', '0.00', '12.00', 0, 1),
('2021-06', '2021-06-01', '2021-06-30', '16.00', '16.00', '0.00', '16.00', 0, 2),
('2021-06', '2021-06-01', '2021-06-30', '0.00', '0.00', '0.00', '0.00', 0, 3),
('2021-06', '2021-06-01', '2021-06-30', '6.00', '6.00', '0.00', '6.00', 0, 4),
('2021-10', '2021-10-01', '2021-10-31', '12.00', '50.00', '0.00', '62.00', 1, 1),
('2021-10', '2021-10-01', '2021-10-31', '16.00', '0.00', '0.00', '16.00', 1, 2),
('2021-10', '2021-10-01', '2021-10-31', '0.00', '100.00', '0.00', '100.00', 1, 3),
('2021-10', '2021-10-01', '2021-10-31', '6.00', '152.00', '20.00', '138.00', 1, 4);
...
(1, '00000001', '2019-10-28 10:28:52', 2, 'LAPTOP', '215', 1, '', 1, 'PANTALLA', 'NINGUNAS', '50.00', '50.00', 'HHH', 'REPARADO', '50.00', '100.00', '2019-10-28 11:29:43', '2019-10-28 11:29:48', 'QUEENS', '50.00'),
(4, '00000004', '2019-12-24 21:11:23', 14, 'LAPTOP ACER', 'SA254', 2, '2454884', 1, 'PANTALLA NO ENCIENDE', 'LO NECESITAN DE FORMA URGNTE', '0.00', '0.00', 'LA PANTALLA NECESITA CAMBIO', 'REPADO', '250.00', '50.00', '2019-12-24 22:12:41', '2019-12-27 22:12:47', 'LLEVAR A DOMICILIO', '300.00'),
(5, '00000005', '2019-12-28 08:49:26', 1, 'TRAJE', '123', 1, '123', 1, 'LIMPIEZA', 'LIEPOIEZA', '0.00', '0.00', 'REALIZADO', 'ENTREGADO', '0.00', '100.00', '2019-12-28 10:50:10', '2019-12-28 10:50:12', 'LA PAZ', '100.00'),
(6, '00000006', '2019-12-28 08:55:49', 1, 'CAMISA', 'AAA', 1, 'A12', 1, 'LIMPIEZA', 'LIMPIEZA', '100.00', '100.00', 'FGH', 'ENTREGADOI', '0.00', '100.00', '2019-12-28 10:50:10', '2019-12-21 10:50:12', 'LA ', '-100.00'),
(8, '00000008', '2020-01-19 13:49:50', 1, 'CABLE', 'RE343434', 6, '', 1, 'DSSD', 'DSD', '0.01', '0.02', '', '', '0.00', '0.00', NULL, NULL, NULL, '-0.03'),
(9, '00000009', '2020-01-20 09:10:38', 2, 'LAPTOP', '55', 5, '', 2, 'PANTALLA', 'DWDW', '0.00', '0.00', '', '', '0.00', '0.00', NULL, NULL, NULL, '0.00');
...
(1, 'GRUPO JHENSCAR S.A.C.', 'PEDRO PABLO BLAS DELGADO', '46591170', '5785533017', '18.00', '0.00', '0.00', 'JR CIRO ALEGRIA 607 5TA ZONA COLLIQUE', NULL, 2);
...
(1, 'UNIDAD', 'UND', 1),
(2, 'LANGERS', 'LGS', 0),
(3, 'ORGANIZADOR NEVERA', 'ORGAN NEVER', 0),
(4, 'MULTIUSOS', 'MULTIU', 0),
(5, 'ESCURRIDOR', 'ESCU', 0),
(6, 'PLATOS BAMBU', 'PLTOS BAMBU', 0),
(7, 'CANGUROS FIT', 'CANG', 0),
(8, 'PARLANTES', 'PARL', 0),
(9, 'AUDIFONOS', 'AUDIF', 0),
(10, 'BROCHAS MAQUILLAJE', 'BROCH', 0);
...
CREATE TABLE `producto` (
  ...
  `codigo_afectacion` char(2) DEFAULT NULL,
...
INSERT INTO `proveedor` (`idproveedor`, `codigo_proveedor`, `nombre_proveedor`, `numero_telefono`, `numero_nit`, `numero_nrc`, `nombre_contacto`, `telefono_contacto`, `estado`) VALUES
(5, 'PROV00000001', 'GRUPO DELTRON S.A.', '936104288', '', '20212331377', 'EVER CURICO', '936104288', 1),
(6, 'PROV00000006', 'JYS SOLUCIONES', '9999999', '0000000', '20513909030', 'NOEMI RIJAS', '970070454', 1);
...
(1, '2021-10', '2021-10-17', 'POR VENTA FACTURA # 1', '12.00', '4.50', '54.00', 4, 1, NULL),
(2, '2021-10', '2021-10-18', 'POR VENTA FACTURA # 2', '6.00', '4.50', '27.00', 4, 2, NULL),
(3, '2021-10', '2021-10-18', 'POR VENTA FACTURA # 3', '2.00', '4.50', '9.00', 4, 3, NULL);
...
CREATE TABLE `subcategorias` (
  `codisubcategoria` int(11) NOT NULL,
  `idcategoria` int(11) NOT NULL COMMENT 'categorias que pertenece a subcategorias',
  `desubcategorias` varchar(450) NOT NULL,
...
INSERT INTO `subcategorias` (`codisubcategoria`, `idcategoria`, `desubcategorias`, `estado`) VALUES
(1, 1, 'NEBLINERO', 1);
...
(1, '2020-01-20 00:23:11', '20172811', '14541474584', 1, 4000, 1, 4000),
(2, '2019-08-03 00:23:11', '1214584575', '11545887911', 1, 100, 2, 100),
(3, '2017-11-28 10:56:11', '15415421542', '6554512412', 1, 5000, 3, 4997);
...
(1, 'V00000001', '2021-10-17 18:19:40', 'EFECTIVO', 1, 3, '101.69', '18.31', '0.00', '0.00', '0.00', '120.00', 'Ciento veinte 00/100', '150.00', '0.00', '', '', '30.00', 1, 1, 1),
(2, 'V00000002', '2021-10-18 02:21:59', 'EFECTIVO', 2, 3, '50.85', '9.15', '0.00', '0.00', '0.00', '60.00', 'Sesenta 00/100', '70.00', '0.00', '', '', '10.00', 1, 1, 1),
(3, 'V00000003', '2021-10-18 23:14:08', 'EFECTIVO', 3, 3, '16.95', '3.05', '0.00', '0.00', '0.00', '20.00', 'Veinte 00/100', '30.00', '0.00', '', '', '10.00', 1, 1, 1);
...
ALTER TABLE `subcategorias`
  ADD PRIMARY KEY (`codisubcategoria`),
...
--
ALTER TABLE `subcategorias`
  MODIFY `codisubcategoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
