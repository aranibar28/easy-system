	...
	<div class="panel panel-flat">
		<div class="breadcrumb-line">
			<ul class="breadcrumb">
				...
				<li class="active">Material del Productos</li>
			</ul>
		</div>
		<div class="panel-heading">
			<h5 class="panel-title">Material del Productos</h5>

			<div class="heading-elements">
				<button type="button" class="btn btn-primary heading-btn" onclick="newMarca()">
									...
									<ul class="icons-list">
										<li class="dropdown">
											...
											<ul class="dropdown-menu dropdown-menu-right">
												<li><a href="javascript:;" data-toggle="modal" data-target="#modal_iconified" onclick="openMarca('editar',
								                     '<?php print($column["idmarca"]); ?>',
								                     '<?php print($column["nombre_marca"]); ?>',
								                     '<?php print($column["estado"]); ?>')">
														<i class="icon-pencil6">
														</i> Editar</a></li>
												<li><a href="javascript:;" data-toggle="modal" data-target="#modal_iconified" onclick="openMarca('ver',
								                     '<?php print($column["idmarca"]); ?>',
								                     '<?php print($column["nombre_marca"]); ?>',
								                     '<?php print($column["estado"]); ?>')">
														<i class=" icon-eye8">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-8">
									...
									<input type="text" id="txtMarca" name="txtMarca" placeholder="EJ. SAMSUNG" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
								</div>
							</div>
						</div>
