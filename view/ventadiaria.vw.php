<?php
	...
	$objVenta =  new Venta();
	$count_ventas = $objVenta->Count_Ventas('HOY','','');
					...
					<div class="panel panel-flat">
						<div class="breadcrumb-line">
							<ul class="breadcrumb">
								...
								<li class="active">Ventas del Dia</li>
							</ul>
						</div>
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
														  ...
														  <?php
																$filas = $objVenta->Listar_Ventas('HOY','','',1);
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
														  ...
														  <?php
																$filas = $objVenta->Listar_Ventas('HOY','','',0);
																if (is_array($filas) || is_object($filas))
																{
																foreach ($filas as $row => $column)
																{
												...
												<div class="panel-body">
													<table class="table datatable-basic table-xs table-hover">
														...
														<tbody>
														  ...
														  <?php
																$filas = $objVenta->Listar_Ventas('HOY','','',2);
																if (is_array($filas) || is_object($filas))
																{
																foreach ($filas as $row => $column)
																{
...
<!-- Iconified modal -->
	...
	<script type="text/javascript" src="web/custom-js/ventadia.js"></script>
