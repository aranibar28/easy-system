								...
								?>
									<tr>
					            		...
					            		<td><?php if($column['tipo_usuario'] == '1')
					                		...
					                		elseif ($column['tipo_usuario'] == '2')
					                		echo '<span class="label label-success label-rounded w-100">
					                		<span class="text-bold">VENDEDOR</span></span>';
											elseif ($column['tipo_usuario'] == '3')
					                		echo '<span class="label label-success label-rounded">
					                		<span class="text-bold">COMPRAS</span></span>';
											elseif ($column['tipo_usuario'] == '4')
					                		echo '<span class="label label-success label-rounded">
					                		<span class="text-bold">INVENTARIO</span></span>';
											else echo '<span class="label label-success label-rounded">
					                		<span class="text-bold">SERVICIOS</span></span>'
						                ?></td>
