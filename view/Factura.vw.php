                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="tipocomp" id="tipocomp" onchange="ConsultarSerie()">
                                        <?php while($fila = $comprobantes->fetch(PDO::FETCH_NAMED)){ ?>
                                            <option value="<?php echo $fila['idcomprobante'];?>"><?php echo $fila['nombre_comprobante'];?></option>
                                        <?php } ?>
                                    </select>
                                </div>	
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                <div class="input-group">
                                        ...
                                        <div class="input-group-btn">
                                            <button type="button" class="btn btn-success" onclick="BuscarProducto()"><li class="fa fa-search"></li></button>	
                                        </div>
                                    </div>
                                <div class="col-12">
...
<script>
   $('#tipocomp').val('01'); //asignando el valor por defecto de Factura
