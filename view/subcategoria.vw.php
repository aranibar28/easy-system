			...
			<div class="panel panel-flat">
				<div class="breadcrumb-line">
					<ul class="breadcrumb">
						...
						<li class="active">Subcategoria de Productos</li>
					</ul>
				</div>
					<div class="panel-heading">
						<h5 class="panel-title">Subcategoria de Productos</h5>

						<div class="heading-elements">
							<button type="button" class="btn btn-primary heading-btn"
							onclick="newSubcategoria()">
										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													...
													onclick="openSubcategoria('editar',
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-8">
												...
												<input type="text" id="txtSubcategoria" name="txtSubcategoria" placeholder="EJ. TECNOLOGIA"
