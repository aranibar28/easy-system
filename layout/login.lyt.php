...
<head>
    ...
    <meta name="autor" content="Tres Niveles">
    <meta name="description" content="Ventas es un sistema de ventas que le permite llevar el control de todo lo relacionado a su negocio.">
    ...
    <link href="web/assets/css/argon.min.css" rel="stylesheet" type="text/css">
    <link href="web/assets/css/AdminLTE.min.css" rel="stylesheet" type="text/css">
    ...
    <link rel="shortcut icon" href="web/assets/images/easybillingicon.png">
