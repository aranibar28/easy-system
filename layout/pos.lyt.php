...
<head>
	...
	<meta name="autor" content="Doctor pc arequipa">
	<meta name="description" content="Easy System es un sistema de ventas que le permite llevar el control de todo lo relacionado a su negocio.">
	...
	<script type="text/javascript" src="web/assets/js/plugins/notifications/pnotify.min.js"></script>
	<script type="text/javascript" src="web/assets/js/plugins/notifications/noty.min.js"></script>
	...
	<script type="text/javascript" src="web/assets/js/plugins/velocity/velocity.min.js"></script>
	<script type="text/javascript" src="web/assets/js/plugins/velocity/velocity.ui.min.js"></script>
	<script type="text/javascript" src="web/assets/js/plugins/buttons/spin.min.js"></script>
	<script type="text/javascript" src="web/assets/js/plugins/buttons/ladda.min.js"></script>

	<script type="text/javascript" src="web/assets/js/core/libraries/jquery_ui/core.min.js"></script>
	<script type="text/javascript" src="web/assets/js/core/libraries/jquery_ui/interactions.min.js"></script>
	<script type="text/javascript" src="web/assets/js/core/libraries/jquery_ui/widgets.min.js"></script>
	<script type="text/javascript" src="web/assets/js/core/libraries/jquery_ui/effects.min.js"></script>
	<script type="text/javascript" src="web/assets/js/plugins/extensions/mousewheel.min.js"></script>
	<script type="text/javascript" src="web/assets/js/core/libraries/jquery_ui/globalize/globalize.js"></script>
...
<body class="has-detached-right pace-done sidebar-xs">
	...
	<div class="navbar navbar-inverse">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			<ul class="nav navbar-nav">
				<li><a class="sidebar-control sidebar-main-hide hidden-xs" data-popup="tooltip" title="Ocultar Lateral" data-placement="bottom" data-container="body">
						<i class="icon-lan3"></i>
					</a></li>
			</ul>
