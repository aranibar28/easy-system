                    ...
                    <div class="form-group">
                        ...
                        <?php if ($tipo_usuario == '1'): ?>
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" id="txtPVenta3" name="txtPVenta3" placeholder="EJ. 1.25"
                                       class="touchspin-prefix" value="0" style="text-transform:uppercase;"
                                       onkeyup="javascript:this.value = this.value.toUpperCase();">
                            </div>
...
?>
                            ...
                            <div class="col-sm-6">
    <label for="banner">Imagen del Producto:</label>
    <div class="input-group">
        <label class="input-group-btn">
            <span class="btn btn-primary btn-file"> Subir Archivo <input accept=".jpg,.png,.jpeg,.gif" class="hidden" name="banner" type="file" id="banner" /> </span>
        </label>
