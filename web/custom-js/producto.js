$(function () {
  ...
  jQuery.validator.addMethod(
    ...
    function (value, element) {
      return (
        this.optional(element) || /^[a-z\s 0-9 , . / () # -]+$/i.test(value)
      );
    },
  ...
  $("#modal_iconified").on("shown.bs.modal", function () {
    ...
    if (action == "nuevo") {
      ...
      if (exento == "1") {
        ...
        document.getElementById("lblchk-e").innerHTML = "CON VA";
      }
...
function enviar_frm() {
  ...
  var precio_venta_3 = $("#txtPVenta3").val();
...
function Print_Report(Criterio) {
  if (Criterio == "Activos") {
    window.open(
      "reportes/Productos_Activos.php",
      "win2",
    ...
    window.open(
      "reportes/Productos_Inactivos.php",
      "win2",
      "status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes," +
    ...
    window.open(
      "reportes/Productos_Agotados.php",
      "win2",
      "status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes," +
        "resizable=yes,width=600,height=600,directories=no,location=no" +
        "fullscreen=yes"
    ...
    window.open(
      "reportes/Productos_Vigentes.php",
      "win2",
      "status=yes,toolbar=yes,scrollbars=yes,titlebar=yes,menubar=yes," +
        "resizable=yes,width=600,height=600,directories=no,location=no" +
        "fullscreen=yes"
