...
function newSubcategoria()
 {
    openSubcategoria('nuevo',null,null);
    $('#modal_iconified').modal('show');
 }
function openSubcategoria(action,codisubcategoria,idcategoria,desubcategorias,estado)
 {
      var mySwitch = new Switchery($('#chkEstado')[0], {
          size:"small",
          color: '#0D74E9'
    ...
    $('#modal_iconified').on('shown.bs.modal', function () {
     ...
     if (action == 'nuevo'){
      ...
      $('#txtSubcategoria').prop( "disabled" , false);
      ...
      modal.find('.title-form').text('Ingresar Subcategoria de Productos');
      ...
      $('#txtSubcategoria').val(desubcategorias);
      ...
      modal.find('.title-form').text('Actualizar Subccategoria de Productos');
     } else if(action=='ver'){
      $('#txtProceso').val('');
      $('#txtID').val(idcategoria);
      $('#txtSubcategoria').val(desubcategorias);
...
function enviar_frm()
{
  var urlprocess  'web/ajax/ajxsubcatecategoria.php';
     ...
     success: function(data){
        ...
        if(data=="Validado"){
             ...
             if(proceso=="Registro"){
              ...
              cargarDiv("#reload-div","web/ajax/reload-subcategoria.php");
              limpiarform();
